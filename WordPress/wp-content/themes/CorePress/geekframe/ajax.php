...
function corepress_get_widget_sentence()
{
    ...
    $data['code'] = 200;
    if ($type == 'djt') {
        $data['data'] = sub_sentence_str(file_get_contents('https://api.oick.cn/dutang/api.php'));
    } elseif ($type == 'tg') {
        $data['data'] = sub_sentence_str(file_get_contents('https://api.oick.cn/dog/api.php'));
    } elseif ($type == 'yy') {
        $data['data'] = sub_sentence_str(file_get_contents('https://api.oick.cn/yiyan/api.php'));
    } elseif ($type == 'sh') {
        $data['data'] = sub_sentence_str(file_get_contents('https://api.oick.cn/yulu/api.php'));
    } else {
        $data['data'] = sub_sentence_str(file_get_contents('https://api.oick.cn/dutang/api.php'));
    }
    wp_die(json_encode($data));
