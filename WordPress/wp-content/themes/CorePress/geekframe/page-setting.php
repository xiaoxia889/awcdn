        ...
        <div class="setmain">
            <div class="header-set-title">
                <div class="header-set-title-name">
                    <?php file_load_img('corepress2.svg') ?><h2>CorePress 设置中心 <span class="corepress-type">Free</span></h2>

                </div>
                <div>
                    <el-link href="https://support.qq.com/products/326735/" :underline="false" target="_blank">
