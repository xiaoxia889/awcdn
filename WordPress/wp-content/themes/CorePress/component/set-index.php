...
<div class="swiper-plane">
    ...
    <el-collapse>
        <draggable v-model="set.index.swiperlist" group="hdp" @start="drag=true" @end="drag=false">
...
<div class="index-card-plane">
    ...
    <el-collapse>
        <draggable v-model="set.index.postcard" group="hdp" @start="drag=true" @end="drag=false">
