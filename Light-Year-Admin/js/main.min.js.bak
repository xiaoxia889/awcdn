console.log(" © 2019 - 2020 北云","backgroud:#FFFFFF;color:#00CD00");
console.log(" Powered by Xiaoyu.","backgroud:#FFFFFF;color:#00CD00");
console.log(" Version: 2020-11-11","backgroud:#FFFFFF;color:#00CD00");
console.log(" ","backgroud:#FFFFFF;color:#00CD00");
console.log(" ===","backgroud:#FFFFFF;color:#00CD00");
console.log(" 「世界は続いてる 君を目指しながら」","backgroud:#FFFFFF;color:#00CD00");
jQuery( function() {
